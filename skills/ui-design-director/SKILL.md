...
1. **Context gate:** Establish a compact concept brief from repository evidence and user input: product/job, audience, interaction archetype, essential screens, content density, brand traits, constraints, and anti-preferences. Name the archetype explicitly: marketing site, dashboard, editing tool, form workflow, or content reader. Ask only for missing information that would materially change the shortlist; label inferred items.
